...
void tambahJadwal(string nim) {
    ...
    style();
    cout << "Nomor Tiket                : " << baru->kodePenerbangan << endl;
    cout << "Tujuan Penerbangan         : " << baru->tujuan << endl;
    cout << "Status Penerbangan         : " << baru->status << endl;
    style();
...
// Fungsi untuk menampilkan semua jadwal penerbangan yang ada dari belakang
void tampilkanJadwalDariBelakang() {
    if (tail == nullptr) {
        cls();
        cout << "Data jadwal kosong.\n";
        delay(2);
        return;
    }
    ...
    while (temp != nullptr) {
        ...
        cin.get();
        cls();
        temp = temp->prev; // mundur
    }
}

// Mencari data dengan detail
void cariDetail() {
    if (head == nullptr) {
        cls();
        cout << "Data jadwal kosong.\n";
    ...
    cout << "1. Kode Penerbangan\n";
    cout << "2. Tujuan Penerbangan\n";
    ...
    bool ditemukan = false;
    while (temp != nullptr) {
        if ((pilih == 1 && temp->kodePenerbangan == input) ||
            (pilih == 2 && temp->tujuan == input)) {
            cls();
            style2();
            cout << "Detail Jadwal Ditemukan :\n";
            cout << "Kode Penerbangan : " << temp->kodePenerbangan << endl;
            cout << "Tujuan           : " << temp->tujuan << endl;
            cout << "Status           : " << temp->status << endl;
            style();
...
int main() {
    ...
    do {
        ...
        cout << "5. Tampilkan Jadwal Penerbangan (Dari Depan)\n";
        cout << "6. Tampilkan Jadwal Penerbangan (Dari Belakang)\n";
